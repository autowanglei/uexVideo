...
public class VideoPlayerActivity extends Activity implements OnPreparedListener, OnClickListener,
    ...
    private GestureDetector gestureDetector = new GestureDetector(new SimpleOnGestureListener() {
        ...
        public boolean onDoubleTap(MotionEvent event) {
            adjustMediaPlayerScreen(displayMode);
    ...
    private void initViews() {
        ...
        m_ivNextStep = (ImageView) findViewById(finder.getId
                ("plugin_video_player_quick_next_step"));
    ...
    public void adjustMediaPlayerScreen(int displayMode) {
    ...
    public void adjustMediaPlayerState(int curerntState) {
        try {
            switch (curerntState) {
                case STATE_PLAYING:
                    pauseMediaPlayer();
    ...
    public void onClick(View v) {
        if (v == m_ivBack) {
            ...
            adjustMediaPlayerState(curerntState);
     ...
     * @param mode
     */
    private void setVideoDisplayMode(int mode) {
        switch (mode) {
            // 宽度适应，默认
            case MODE_WIDTH_FIT:
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        alertMessage(finder.getString("plugin_video_can_not_support_this_format_video_playback"),
                true);
        return true;
    }
